...
1. **Quality Control**
   - Tool: `FastQC`
   - Purpose: Assess base quality, GC content, adapter contamination of raw reads.

2. **Read Alignment**
   - Tool: `BWA-MEM`
   - Align reads to the reference genome (Hg19).
...
cd targeted-exome-seq-analysis
```
...
conda activate exome_seq
```
### Reference Files Prerequisite
